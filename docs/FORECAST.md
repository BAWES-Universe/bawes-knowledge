# FORECAST — next 8h (machine-computed 2026-08-22T05:04)

- **Measured rate** (60s live sample): **0.0 samples/hr** (n 125->125)
...
- Dataset at t=8h: **~125 samples**
- Training cycles in window: **1**
  - cycle at 0.97h: train on 125 samples (0.97h)
