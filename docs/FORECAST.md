# FORECAST — next 8h (machine-computed 2026-08-23T08:05)

- **Measured rate** (60s live sample): **0.0 samples/hr** (n 336->336)
...
- Dataset at t=8h: **~336 samples**
- Training cycles in window: **1**
  - cycle at 9.74h: train on 336 samples (9.74h)
