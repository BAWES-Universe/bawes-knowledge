# FORECAST — next 8h (machine-computed 2026-08-22T15:05)

- **Measured rate** (60s live sample): **0.0 samples/hr** (n 266->266)
...
- Dataset at t=8h: **~266 samples**
- Training cycles in window: **1**
  - cycle at 7.71h: train on 266 samples (7.71h)
