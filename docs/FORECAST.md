# FORECAST — next 8h (machine-computed 2026-08-23T01:05)

- **Measured rate** (60s live sample): **0.0 samples/hr** (n 324->324)
...
- Dataset at t=8h: **~324 samples**
- Training cycles in window: **0**
