# FORECAST — next 8h (machine-computed 2026-08-22T16:05)

- **Measured rate** (60s live sample): **0.0 samples/hr** (n 274->274)
...
- Dataset at t=8h: **~274 samples**
- Training cycles in window: **1**
  - cycle at 7.95h: train on 274 samples (7.95h)
