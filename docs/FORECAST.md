# FORECAST — next 8h (machine-computed 2026-08-23T03:05)

- **Measured rate** (60s live sample): **0.0 samples/hr** (n 329->329)
...
- Dataset at t=8h: **~329 samples**
- Training cycles in window: **1**
  - cycle at 9.54h: train on 329 samples (9.54h)
